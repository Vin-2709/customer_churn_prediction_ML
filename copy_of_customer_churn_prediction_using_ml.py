...
# Drop ID and fix TotalCharges formatting
...
def plot_histogram(df, column_name):
    ...
    col_mean, col_median = df[column_name].mean(), df[column_name].median()
...
# Encode categorical features and save encoders for later use
